#
#  Be sure to run `pod spec lint YMMicQueueView.podspec' to ensure this is a
...
mic queue proj
  ...
  spec.homepage     = "http://github.com/aio-ani/YMMicQueueView"
  ...
  spec.source       = { :git => "http://github.com/aio-ani/YMMicQueueView.git", :tag => "#{spec.version}" }
